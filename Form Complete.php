...
<html lang="en">
    ...
    <body>  
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
            ...
            <label>E-mail:</label> 
            <input type="text" name="email" placeholder="Enter E-mail" value="<?php echo $email?>">
            <span class="error">* <?php echo $emailErr;?></span>
            <br><br>

            <label>Website:</label> 
            <input type="text" name="website" placeholder="www.example.com" value="<?php echo $website?>">
            <span class="error"><?php echo $websiteErr;?></span>
            <br><br>

            <label>Comment:</label> 
            <textarea name="comment" rows="5" cols="40" placeholder="Comment here" <?php echo $comment?>></textarea>
            <br><br>
